<div class="row align-items-center">
    ...
    <div class="col"> 
        <input type="search" id="search" class="form-control" placeholder="Caută produs" style="margin-left:-2rem;width:10rem;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"/> 
...
$('#search').on("keyup", function() {
    value = $('#search').val();
    novalue = "Produsul nu a fost găsit";
        if(value != ""){
        $.ajax({
            type : 'get',
            url : "{{ url('/search') }}",
