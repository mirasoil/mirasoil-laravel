            ...
            <div class="col-md-6 ">
                ...
                @csrf
                    <div class="form-group ">
                        <input type="text " name="name" id="name" class="form-control contact-control {{ $errors->has('name') ? 'error' : '' }}" placeholder="Numele dumneavoastră " required="required">
                        <!-- Error -->
                        @if ($errors->has('name'))
                        <div class="error">
                            {{ $errors->first('name') }}
                    ...
                    <div class="form-group ">
                        <input type="email " name="email" id="email" class="form-control contact-control {{ $errors->has('email') ? 'error' : '' }}" placeholder="Email " required="required">
                        @if ($errors->has('email'))
                        <div class="error">
                            {{ $errors->first('email') }}
                        </div>
                    ...
                    <div class="form-group ">
                        <input type="tel" name="phone" id="phone" class="form-control contact-control {{ $errors->has('phone') ? 'error' : '' }}" placeholder="Număr de telefon " required="required">
                        @if ($errors->has('phone'))
                        <div class="error">
                            {{ $errors->first('phone') }}
                        </div>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control contact-control {{ $errors->has('subject') ? 'error' : '' }}" name="subject" id="subject" placeholder="Subiect">
                    ...
                    <div class="form-group ">
                        <textarea class="form-control contact-control {{ $errors->has('message') ? 'error' : '' }}" name="message" id="message" rows="4 " placeholder="Mesaj " required="required"></textarea>
